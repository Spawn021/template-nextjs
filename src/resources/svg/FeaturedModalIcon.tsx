export default function FeaturedIcon() {
  return (
    <svg width='56' height='56' viewBox='0 0 56 56' fill='none' xmlns='http://www.w3.org/2000/svg'>
      <rect x='4' y='4' width='48' height='48' rx='24' fill='#CFF2FF' />
      <rect x='4' y='4' width='48' height='48' rx='24' stroke='#EBFAFF' strokeWidth='8' />
      <path
        d='M24.5 30.6667C24.5 31.9553 25.5447 33 26.8333 33H29C30.3807 33 31.5 31.8807 31.5 30.5C31.5 29.1193 30.3807 28 29 28H27C25.6193 28 24.5 26.8807 24.5 25.5C24.5 24.1193 25.6193 23 27 23H29.1667C30.4553 23 31.5 24.0447 31.5 25.3333M28 21.5V23M28 33V34.5M38 28C38 33.5228 33.5228 38 28 38C22.4772 38 18 33.5228 18 28C18 22.4772 22.4772 18 28 18C33.5228 18 38 22.4772 38 28Z'
        stroke='#007BE0'
        strokeWidth='2'
        strokeLinecap='round'
